...
class OpenApiConfigTest {
    ...
    void shouldConfigureApiInfoCorrectly() {
        ...
        assertEquals("Loan Application API", info.getTitle(), "API title should match");
        assertEquals("1.0.0", info.getVersion(), "API version should match");
        assertEquals("API for loan application", info.getDescription(), "API description should match");
    }
    ...
    void shouldConfigureServersCorrectly() {
        ...
        assertEquals("http://localhost:8081", server.getUrl(), "Server URL should match");
